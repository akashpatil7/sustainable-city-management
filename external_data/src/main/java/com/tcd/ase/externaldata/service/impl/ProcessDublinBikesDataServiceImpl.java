...
public class ProcessDublinBikesDataServiceImpl implements ProcessDublinBikesDataService {
    ...
    private DublinBikes convertData(DublinBike dublinBike) {
        ...
        DublinBikes bikeData = new DublinBikes.DublinBikesBuilder()
                                .withId(dublinBike.getId())
                                ...
                                .withBikeStands(dublinBike.getBike_stands())
                                .withAvailableBikes(dublinBike.getAvailable_bikes())
                                .withBanking(dublinBike.getBanking())
                                .withBonus(dublinBike.getBonus())
                                .withLastUpdate(convertDateToTimestamp(dublinBike.getLast_update()))
                                .withStatus(dublinBike.getStatus())
                                .withAddress(dublinBike.getAddress())
                                .withName(dublinBike.getName())
                                .withLatitude(dublinBike.getLatitude())
                                .withLongitude(dublinBike.getLongitude())
                                .build();
        return bikeData;
    }
}